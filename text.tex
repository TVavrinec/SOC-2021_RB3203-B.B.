...
\makethanks{    
    Děkuji svému školiteli Mgr. Miroslavu Burdovi za obětavou pomoc, podnětné připomínky 
    a~hlavně nekonečnou trpělivost, kterou mi během práce poskytoval.
}
...
% Výsledné zařízení má k dispozici řadu periferií, díky kterým může reagovat na řadu vjemů, dá se jednoduše programovat,  a tak je vhodné třeba pro výuku programování.
...
% is based on an electronic safe,
...
\appendix
\chapter{Zpráva od uživatelů BlackBoxu}
\label{papir}
\includepdf[pages=1-2]{kapitoly/Socka-BlackBox-pouzitelnost}
