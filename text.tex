...
\titlecz{Konstrukce trezoru} % český název práce
...
\printbibliography[keyword=online,heading=subbibliography,title={Ostatní internetové zdroje}] %todo nevim jak ve souboru .bib zalamovat odkazi bez jejich zničení dovysvětlim možnosti
