...
\input{kapitoly/E4_obecne.tex} %todo sjednotit s aktuální verzí? 
...
%\addcontentsline{toc}{chapter}{\protect\numberline{\Alph{chapter}}Obrazová příloha} 
%\newcommand\OdsazeniKapitoly{14mm}
%\noindent \huge \textbf{Příloha A} \normalsize 
%\vspace{\OdsazeniKapitoly}
...
\printbibheading
\printbibliography[type   =Manual,heading=subbibliography,title={Technická dokumentace}]
\printbibliography[nottype=Manual,heading=subbibliography,title={Aplikačni záznamy}]
