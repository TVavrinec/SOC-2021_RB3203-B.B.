...
popis B.B.
{
    ...
    Všechny tyto systémy jsou rozloženy na třech deskách.
    Na jedné desce je jen světelný kruh a LDC spolu se snímacími cívkami.
    Na druhé desce je vše ostatní, kromě
    enkodéru, který je realizován jako vylomitelná část hlavní desky. %doladit 
