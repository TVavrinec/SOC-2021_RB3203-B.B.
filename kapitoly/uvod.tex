...
pobočky DDM Helceletova Brno, \href{https://helceletka.cz/robotarna/}{Robotárny} \parencite{robotarna}.
...
s~využitím tohoto výrobku. Z tohoto důvodu jsem začal vyvíjet vlastně elektronicky trezor. Postup vývoje trezoru je popsán v~kapitolách \ref{E-vyvoj} a~\ref{M-vyvoj}.
...
Také využití se rozšířilo -- přibyly nové funkce a hlavním cílem už není pouze trezor  s~dětmi stavět a programovat, 
ale také ho využívat jako herní prvek při táborových i jiných hrách. 
...
Požadavky na elektroniku seřazeni podle důležitosti:
\begin{itemize}
    \item Zámek
    \item LED kruh
    \item Tlaková plocha
