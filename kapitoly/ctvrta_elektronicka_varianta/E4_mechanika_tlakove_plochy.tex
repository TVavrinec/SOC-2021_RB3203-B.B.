...
dělal simulaci, kterou k práci přikládám na obrázcích \ref{fig:E4-simulace_tela} a \ref{fig:E4-simulace_tlakovky}. %todo obrázky se simulací do přílohy, a zde odkaz na č. obr a stránku, podobně i další velké obrázky (nad cca třetinu strany) 
