...
\begin{figure}
    ...
    \caption{Render poslední mechanické varianty}
    \label{fig:M2-render}
\end{figure}


\begin{figure}[h]
    \section{Kopyto na jednu část formy těla dveří}
    \centering
    \includegraphics[width=\textwidth]{kapitoly/obrazky/E4/odlevání/IMG_20210406_121129.jpg}
    \caption{Fotografie jednoho z~kopyt na silikonovou formu}
    \label{fig:E4-kopito}
\end{figure}
...
\begin{figure}
    ...
    Jak je vidět, tak i~sílu 100~N dokáže sendvič z~terčíku, pružné podložky a~snímací desky rozložit na dostatečnou plochu, aby napětí 
    v~těle nestouplo 
...
\begin{figure}[h]
    ...
    \caption{\centering Simulace napětí v~západce při kroutícím momentu \\5000 N $\cdot$ mm, 
            což na rameni 48~mm znamená sílu působící na kolík 104~N}
